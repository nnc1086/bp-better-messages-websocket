...
/*
    ...
    @fs_premium_only /inc/mobile-app/,/inc/websocket.php,/addons/calls.php,/addons/calls-group.php,/inc/mini.php,/assets/js/bp-messages-premium.min.js,/assets/js/bp-messages-premium.min.js.LICENSE.txt,/assets/js/bp-messages-app.min.js,/assets/js/bp-messages-app.min.js.LICENSE.txt,/assets/js/addons/calls,/assets/sounds/calling.mp3,/assets/sounds/calling.ogg,/assets/sounds/dialing.mp3,/assets/sounds/dialing.ogg,/assets/js/bpbm-worker.js,/assets/js/bpbm-worker.min.js,/assets/js/workers/e2ee.worker.js,/assets/js/workers/indexeddb-encrypted.worker.js,/assets/js/workers/opfs-encrypted.worker.js,/assets/js/workers/memory-encrypted.worker.js,/assets/css/mobile-app.scss,/assets/css/mobile-app.css,/assets/css/mobile-app.css.map,/assets/css/mobile-app.min.css,/assets/css/mobile-app.min.css.map
