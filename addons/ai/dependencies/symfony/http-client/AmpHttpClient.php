...
use BetterMessages\Psr\Log\LoggerAwareTrait;
use BetterMessages\Symfony\Component\HttpClient\Exception\TransportException;
use BetterMessages\Symfony\Component\HttpClient\Internal\AmpClientStateV4;
use BetterMessages\Symfony\Component\HttpClient\Internal\AmpClientStateV5;
use BetterMessages\Symfony\Component\HttpClient\Response\AmpResponseV4;
use BetterMessages\Symfony\Component\HttpClient\Response\AmpResponseV5;
...
if (!interface_exists(DelegateHttpClient::class)) {
    throw new \LogicException('You cannot use "BetterMessages\Symfony\Component\HttpClient\AmpHttpClient" as the "amphp/http-client" package is not installed. Try running "composer require amphp/http-client:^4.2.1".');
}

if (\PHP_VERSION_ID < 80400 && is_subclass_of(Request::class, HttpMessage::class)) {
    throw new \LogicException('Using "BetterMessages\Symfony\Component\HttpClient\AmpHttpClient" with amphp/http-client >= 5 requires PHP >= 8.4. Try running "composer require amphp/http-client:^4.2.1" or upgrade to PHP >= 8.4.');
}
