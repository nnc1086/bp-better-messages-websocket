...
use BetterMessages\GuzzleHttp\Promise\Promise as GuzzlePromise;
use BetterMessages\GuzzleHttp\Promise\RejectedPromise;
use BetterMessages\GuzzleHttp\Promise\Utils;
...
use BetterMessages\Nyholm\Psr7\Factory\Psr17Factory as NyholmPsr17Factory;
use BetterMessages\Nyholm\Psr7\Request;
use BetterMessages\Nyholm\Psr7\Uri;
...
use BetterMessages\Symfony\Component\HttpClient\Internal\HttplugWaitLoop;
use BetterMessages\Symfony\Component\HttpClient\Response\HttplugPromise;
...
if (!interface_exists(HttpAsyncClient::class)) {
    throw new \LogicException('You cannot use "BetterMessages\Symfony\Component\HttpClient\HttplugClient" as the "php-http/httplug" package is not installed. Try running "composer require php-http/discovery php-http/async-client-implementation:*".');
}

if (!interface_exists(RequestFactoryInterface::class)) {
    throw new \LogicException('You cannot use the "BetterMessages\Symfony\Component\HttpClient\HttplugClient" as the "psr/http-factory" package is not installed. Try running "composer require php-http/discovery psr/http-factory-implementation:*".');
}
    ...
    public function __construct(?HttpClientInterface $client = null, ?ResponseFactoryInterface $responseFactory = null, ?StreamFactoryInterface $streamFactory = null)
    {
        ...
        if (null === $responseFactory || null === $streamFactory) {
            if (class_exists(Psr17Factory::class)) {
                ...
                throw new \LogicException('You cannot use the "BetterMessages\Symfony\Component\HttpClient\HttplugClient" as no PSR-17 factories have been provided. Try running "composer require php-http/discovery psr/http-factory-implementation:*".');
            }
