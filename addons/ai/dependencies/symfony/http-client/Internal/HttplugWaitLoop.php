...
use BetterMessages\Psr\Http\Message\RequestInterface as Psr7RequestInterface;
...
use BetterMessages\Symfony\Component\HttpClient\Response\StreamableInterface;
use BetterMessages\Symfony\Component\HttpClient\Response\StreamWrapper;
...
final class HttplugWaitLoop
{
    ...
    public function wait(?ResponseInterface $pendingResponse, ?float $maxDuration = null, ?float $idleTimeout = null): int
    {
        ...
        $guzzleQueue = \BetterMessages\GuzzleHttp\Promise\Utils::queue();
