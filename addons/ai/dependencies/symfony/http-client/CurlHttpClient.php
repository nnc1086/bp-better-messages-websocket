...
use BetterMessages\Symfony\Component\HttpClient\Internal\CurlClientState;
use BetterMessages\Symfony\Component\HttpClient\Internal\PushedResponse;
use BetterMessages\Symfony\Component\HttpClient\Response\CurlResponse;
...
final class CurlHttpClient implements HttpClientInterface, LoggerAwareInterface, ResetInterface
{
    ...
    public function __construct(array $defaultOptions = [], int $maxHostConnections = 6, int $maxPendingPushes = 0)
    {
        if (!\extension_loaded('curl')) {
            throw new \LogicException('You cannot use the "BetterMessages\Symfony\Component\HttpClient\CurlHttpClient" as the "curl" extension is not installed.');
        }
