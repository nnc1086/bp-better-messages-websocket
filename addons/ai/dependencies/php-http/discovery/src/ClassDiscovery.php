...
use BetterMessages\Http\Discovery\Exception\ClassInstantiationFailedException;
use BetterMessages\Http\Discovery\Exception\DiscoveryFailedException;
use BetterMessages\Http\Discovery\Exception\NoCandidateFoundException;
use BetterMessages\Http\Discovery\Exception\StrategyUnavailableException;
use BetterMessages\Http\Discovery\Strategy\DiscoveryStrategy;
