...
use BetterMessages\GuzzleHttp\Client as GuzzleHttp;
use BetterMessages\GuzzleHttp\Promise\Promise;
use BetterMessages\GuzzleHttp\Psr7\Request as GuzzleRequest;
...
use BetterMessages\Http\Discovery\ClassDiscovery;
use BetterMessages\Http\Discovery\Exception\NotFoundException;
...
use BetterMessages\Nyholm\Psr7\Factory\HttplugFactory as NyholmHttplugFactory;
use BetterMessages\Psr\Http\Client\ClientInterface as Psr18Client;
use BetterMessages\Psr\Http\Message\RequestFactoryInterface as Psr17RequestFactory;
use Slim\Http\Request as SlimRequest;
use BetterMessages\Symfony\Component\HttpClient\HttplugClient as SymfonyHttplug;
use BetterMessages\Symfony\Component\HttpClient\Psr18Client as SymfonyPsr18;
...
final class CommonClassesStrategy implements DiscoveryStrategy
{
    ...
    {
        return defined('BetterMessages\GuzzleHttp\ClientInterface::MAJOR_VERSION');
    }
