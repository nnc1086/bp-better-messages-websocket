...
class Plugin implements PluginInterface, EventSubscriberInterface
{
    ...
    private const INTERFACE_MAP = [
        ...
        'psr/http-client-implementation' => [
            'BetterMessages\Psr\Http\Client\ClientInterface',
        ],
        'psr/http-factory-implementation' => [
            'BetterMessages\Psr\Http\Message\RequestFactoryInterface',
            'BetterMessages\Psr\Http\Message\ResponseFactoryInterface',
            'BetterMessages\Psr\Http\Message\ServerRequestFactoryInterface',
            'BetterMessages\Psr\Http\Message\StreamFactoryInterface',
            'BetterMessages\Psr\Http\Message\UploadedFileFactoryInterface',
            'BetterMessages\Psr\Http\Message\UriFactoryInterface',
        ],
    ];
