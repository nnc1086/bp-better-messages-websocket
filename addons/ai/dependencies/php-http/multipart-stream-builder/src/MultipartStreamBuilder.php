...
use BetterMessages\Http\Discovery\StreamFactoryDiscovery;
...
class MultipartStreamBuilder
{
     ...
     *
     * @param string|resource|\BetterMessages\Psr\Http\Message\StreamInterface $resource the filepath, resource or StreamInterface of the data
