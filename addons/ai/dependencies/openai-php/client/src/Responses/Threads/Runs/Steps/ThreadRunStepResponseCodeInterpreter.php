...
final class ThreadRunStepResponseCodeInterpreter implements ResponseContract
{
    ...
    /**
     * @param  \BetterMessages\OpenAI\Responses\Threads\Runs\Steps\ThreadRunStepResponseCodeInterpreterOutputLogs[]|\BetterMessages\OpenAI\Responses\Threads\Runs\Steps\ThreadRunStepResponseCodeInterpreterOutputImage[]|null  $outputs
     */
    ...
    {
        $outputs = array_map(
            fn (array $output): \BetterMessages\OpenAI\Responses\Threads\Runs\Steps\ThreadRunStepResponseCodeInterpreterOutputImage|\BetterMessages\OpenAI\Responses\Threads\Runs\Steps\ThreadRunStepResponseCodeInterpreterOutputLogs => match ($output['type']) {
